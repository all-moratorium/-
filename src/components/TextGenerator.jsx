...
const TextGenerator = ({ onNavigateToCustomize, isGuideEffectStopped, onGuideEffectStop, sidebarExpanded = true }) => {
    ...
    const allFonts = [
        // 筆記体
        { name: 'Dancing Script', font: 'Dancing Script, cursive', tags: ['人気', '筆記体'] },
        { name: 'Sacramento', font: 'Sacramento, cursive', tags: ['筆記体', '装飾'] },
        { name: 'Yellowtail', font: 'Yellowtail, cursive', tags: ['筆記体'] },
        { name: 'Arizonia', font: 'Arizonia, cursive', tags: ['筆記体'] },
        { name: 'Rouge Script', font: 'Rouge Script, cursive', tags: ['筆記体'] },
        { name: 'Marck Script', font: 'Marck Script, cursive', tags: ['筆記体'] },
        { name: 'Clicker Script', font: 'Clicker Script, cursive', tags: ['筆記体'] },
        { name: 'Mrs Saint Delafield', font: 'Mrs Saint Delafield, cursive', tags: ['筆記体'] },
        { name: 'Dawning of a New Day', font: 'Dawning of a New Day, cursive', tags: ['筆記体'] },
        { name: 'Great Vibes', font: 'Great Vibes, cursive', tags: ['筆記体', '装飾'] },
        { name: 'Allura', font: 'Allura, cursive', tags: ['筆記体', '装飾'] },
        { name: 'Alex Brush', font: 'Alex Brush, cursive', tags: ['筆記体'] },
        { name: 'Monsieur La Doulaise', font: 'Monsieur La Doulaise, cursive', tags: ['筆記体', '装飾'] },
        { name: 'Imperial Script', font: 'Imperial Script, cursive', tags: ['筆記体', '装飾'] },
        { name: 'Lavishly Yours', font: 'Lavishly Yours, cursive', tags: ['筆記体', 'エレガント'] },
        { name: 'Mea Culpa', font: 'Mea Culpa, cursive', tags: ['筆記体'] },
        { name: 'Hurricane', font: 'Hurricane, cursive', tags: ['筆記体', 'ダイナミック'] },
        { name: 'WindSong', font: 'WindSong, cursive', tags: ['筆記体', 'エレガント'] },
        { name: 'Lovers Quarrel', font: 'Lovers Quarrel, cursive', tags: ['筆記体', 'ロマンティック'] },
        { name: 'Qwitcher Grypen', font: 'Qwitcher Grypen, cursive', tags: ['筆記体', 'エレガント'] },
        { name: 'Ole', font: 'Ole, cursive', tags: ['筆記体', 'カジュアル'] },
        // 手書き
        { name: 'Indie Flower', font: 'Indie Flower, cursive', tags: ['手書き', 'カジュアル'] },
        { name: 'Caveat', font: 'Caveat, cursive', tags: ['手書き', 'カジュアル'] },
        { name: 'Amatic SC', font: 'Amatic SC, cursive', tags: ['シンプル', '手書き'] },
        { name: 'Shadows Into Light', font: 'Shadows Into Light, cursive', tags: ['手書き'] },
        { name: 'Architects Daughter', font: 'Architects Daughter, cursive', tags: ['手書き'] },
        { name: 'Handlee', font: 'Handlee, cursive', tags: ['手書き'] },
        { name: 'Nothing You Could Do', font: 'Nothing You Could Do, cursive', tags: ['手書き'] },
        { name: 'Reenie Beanie', font: 'Reenie Beanie, cursive', tags: ['手書き'] },
        { name: 'Bad Script', font: 'Bad Script, cursive', tags: ['手書き', 'カジュアル'] },
        { name: 'Over the Rainbow', font: 'Over the Rainbow, cursive', tags: ['手書き', 'カジュアル'] },
        // 装飾/レトロ
        { name: 'Cookie', font: 'Cookie, cursive', tags: ['筆記体'] },
        { name: 'Tangerine', font: 'Tangerine, cursive', tags: ['筆記体', '装飾'] },
        { name: 'Leckerli One', font: 'Leckerli One, cursive', tags: ['筆記体'] },
        { name: 'Courgette', font: 'Courgette, cursive', tags: ['筆記体'] },
        { name: 'Butterfly Kids', font: 'Butterfly Kids, cursive', tags: ['装飾'] },
        { name: 'Geostar', font: 'Geostar, cursive', tags: ['装飾', 'レトロ'] },
        { name: 'Warnes', font: 'Warnes, cursive', tags: ['装飾', 'ボールド'] },
        { name: 'Tulpen One', font: 'Tulpen One, cursive', tags: ['装飾', 'レトロ'] },
        { name: 'Snowburst One', font: 'Snowburst One, cursive', tags: ['装飾', 'ユニーク'] },
        { name: 'Kumar One Outline', font: 'Kumar One Outline, cursive', tags: ['アウトライン', '装飾'] },
        { name: 'Londrina Outline', font: 'Londrina Outline, cursive', tags: ['アウトライン', 'ポップ'] },
        // 未来/テック
        { name: 'Monoton', font: 'Monoton, cursive', tags: ['人気', 'ネオン'] },
        { name: 'Audiowide', font: 'Audiowide, cursive', tags: ['未来', 'テック'] },
        { name: 'Orbitron', font: 'Orbitron, cursive', tags: ['未来', 'テック'] },
        { name: 'Syncopate', font: 'Syncopate, cursive', tags: ['未来', 'テック'] },
        { name: 'Michroma', font: 'Michroma, sans-serif', tags: ['未来', 'テック'] },
        { name: 'Petch', font: 'Petch, sans-serif', tags: ['モダン', 'テック'] },
        { name: 'Megrim', font: 'Megrim, cursive', tags: ['未来', 'ユニーク'] },
        { name: 'Faster One', font: 'Faster One, cursive', tags: ['未来', 'テック'] },
        // モダン/幾何学
        { name: 'Comfortaa', font: 'Comfortaa, cursive', tags: ['モダン'] },
        { name: 'Josefin Slab', font: 'Josefin Slab, serif', tags: ['セリフ', 'エレガント'] },
        { name: 'Tsukimi Rounded', font: 'Tsukimi Rounded, sans-serif', tags: ['モダン', '丸ゴシック'] },
        { name: 'Geo', font: 'Geo, sans-serif', tags: ['幾何学', 'モダン'] },
        { name: 'Chakra', font: 'Chakra, sans-serif', tags: ['モダン', 'クリーン'] },
        { name: 'Bungee Hairline', font: 'Bungee Hairline, cursive', tags: ['細線', 'モダン'] },
        // その他
        { name: 'Pacifico', font: 'Pacifico, cursive', tags: ['人気', 'ポップ'] },
        { name: 'Griffy', font: 'Griffy, cursive', tags: ['ユニーク'] },
        { name: 'Courier Prime', font: 'Courier Prime, cursive', tags: ['レトロ'] },
        { name: 'Neonderthaw', font: 'Neonderthaw, cursive', tags: ['ネオン', 'ユニーク'] },
        { name: 'Offside', font: 'Offside, cursive', tags: ['スポーツ', 'カジュアル'] },
        { name: 'Tourney', font: 'Tourney, cursive', tags: ['スポーツ', 'ダイナミック'] },
        // 日本語対応フォント
        { name: 'Noto Sans JP', font: 'Noto Sans JP, sans-serif', tags: ['日本語対応', 'ベーシック', '人気'] },
        { name: 'Noto Serif JP', font: 'Noto Serif JP, serif', tags: ['日本語対応', 'ベーシック'] },
        { name: 'Kosugi', font: 'Kosugi, sans-serif', tags: ['日本語対応', 'ベーシック'] },
        { name: 'Hachi Maru Pop', font: 'Hachi Maru Pop, cursive', tags: ['日本語対応', 'ポップ'] },
        { name: 'Kiwi Maru', font: 'Kiwi Maru, cursive', tags: ['日本語対応', 'ポップ'] },
        { name: 'Stick', font: 'Stick, sans-serif', tags: ['日本語対応', 'ユニーク'] },
        { name: 'Train One', font: 'Train One, cursive', tags: ['日本語対応', 'ポップ'] },
        { name: 'New Tegomin', font: 'New Tegomin, serif', tags: ['日本語対応', '伝統'] },
        { name: 'Yomogi', font: 'Yomogi, cursive', tags: ['日本語対応', '伝統'] },
        { name: 'Kaisei Opti', font: 'Kaisei Opti, serif', tags: ['日本語対応', '伝統'] },
        { name: 'Gamja Flower', font: 'Gamja Flower, cursive', tags: ['日本語対応', 'ゲーム'] },
        { name: 'Shizuru', font: 'Shizuru, cursive', tags: ['日本語対応', 'ゲーム'] },
        { name: 'Klee One', font: 'Klee One, cursive', tags: ['日本語対応', '手書き'] },
        { name: 'Yuji Mai', font: 'Yuji Mai, serif', tags: ['日本語対応', '手書き'] },
        { name: 'WDXL Lubrifont JP N', font: 'WDXL Lubrifont JP N, sans-serif', tags: ['日本語対応', 'モダン'] }
    ];
    ...
    const getFontFamily = (fontName) => {
        const fontMap = {
            ...
            'Syncopate': 'Syncopate, cursive',
            'Michroma': 'Michroma, sans-serif',
            'Petch': 'Petch, sans-serif',
            ...
            'Courier Prime': 'Courier Prime, cursive',
